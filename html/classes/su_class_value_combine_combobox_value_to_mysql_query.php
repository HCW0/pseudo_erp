<?php
    ...
    class su_class_value_combine_combobox_value_to_mysql_query{
            ...
            function su_function_combine_query_to_task_header_table_spaghetti_wo_kiwameru($level,$sub_level,$order_dpt,$orderer,$priority,$state,$base_date,$limit_date,$dstate){

                    $query_head = "select * from task_document_header_table u where u.reserve_flag = ".$_SESSION['reserve_index']." AND ";
                    ...
                    $query_where_priority = $priority!=3 ? "u.task_priority = $priority ": "(u.task_priority = 0 OR u.task_priority = 1)";
                      ...
                      return $query_head.$query_where_level.$query_where_sub_level.$query_where_order_dpt.$query_where_orderer.$query_where_state.$query_where_dstate.$query_where_base_date.$query_where_limit_date.$query_where_priority.$query_where_semi_colon;
