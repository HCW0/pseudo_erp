...
?>
	...
	<body>
		...
		?>
					...
					<input type="button" name="버튼" value="공문등록" onclick="window.open('./su_script_former_write_interface.php','win','width=630,height=286,toolbar=0,scrollbars=0,resizable=0')";>
