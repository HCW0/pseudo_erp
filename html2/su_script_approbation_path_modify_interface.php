  ...
  .fixed-table-container {
	...
	<div id="wrapper" style="width:100%" "height:150px">
				...
				<div style="padding:20px 0px 20px 0px;">
						...
						<div>부서명
							<?php 
								echo $ob2->su_function_convert_name($conn,"master_department_info_table","sid_combine_department",$_SESSION['current_department_of_management_path'],"master_department_info_name");														
							?>
						</div>

						<div>유저명
							<?php
								echo $ob2->su_function_convert_name($conn,"master_user_info_table","SID",$_SESSION['current_sid_of_management_path'],"master_user_info_name");														
      						?>          
   							</select>	
						</div>
				...
				<?php
						$task_table_query = "SELECT * FROM task_approbation_path_table u WHERE u.sid = $sid AND u.key_index = $key;";
                ...
                <tr>
					...
					<td>
						<form action = '<?php echo "outsource6path_modify.php?sid=".$sid."&key=".$key.";" ?>' method='POST' name="table_filter">	
										 		...
										 		echo "<option value='-1'>--</option>";
           										 while( $row=mysqli_fetch_array($result) ){
														...
														$name_Value = $ob2->su_function_convert_name($conn,"master_user_info_table","SID",$row['SID'],"master_user_info_name");
																					...
																					if($row2['1_layer_aida_sid']==$row['SID']){
																						echo "<option value='".$row['SID']."' selected>".$name_Value."</option>";         																																				                                    
																					}else{
																						echo "<option value='".$row['SID']."'>".$name_Value."</option>";    
																					}
										 		...
										 		echo "<option value='-1'>--</option>";
           										 while( $row=mysqli_fetch_array($result) ){
														...
														$name_Value = $ob2->su_function_convert_name($conn,"master_user_info_table","SID",$row['SID'],"master_user_info_name");
																					...
																					if($row2['2_layer_aida_sid']==$row['SID']){
																						echo "<option value='".$row['SID']."' selected>".$name_Value."</option>";         																																				                                    
																					}else{
																						echo "<option value='".$row['SID']."'>".$name_Value."</option>";    
																					}
										 		...
										 		echo "<option value='-1'>--</option>";
           										 while( $row=mysqli_fetch_array($result) ){
														...
														$name_Value = $ob2->su_function_convert_name($conn,"master_user_info_table","SID",$row['SID'],"master_user_info_name");
																					...
																					if($row2['3_layer_aida_sid']==$row['SID']){
																						echo "<option value='".$row['SID']."' selected>".$name_Value."</option>";         																																				                                    
																					}else{
																						echo "<option value='".$row['SID']."'>".$name_Value."</option>";    
																					}
										 		...
										 		echo "<option value='-1'>--</option>";
           										 while( $row=mysqli_fetch_array($result) ){
														...
														$name_Value = $ob2->su_function_convert_name($conn,"master_user_info_table","SID",$row['SID'],"master_user_info_name");
																					...
																					if($row2['4_layer_aida_sid']==$row['SID']){
																						echo "<option value='".$row['SID']."' selected>".$name_Value."</option>";         																																				                                    
																					}else{
																						echo "<option value='".$row['SID']."'>".$name_Value."</option>";    
																					}
										 		...
										 		echo "<option value='-1'>--</option>";
           										 while( $row=mysqli_fetch_array($result) ){
														...
														$name_Value = $ob2->su_function_convert_name($conn,"master_user_info_table","SID",$row['SID'],"master_user_info_name");
																					...
																					if($row2['5_layer_aida_sid']==$row['SID']){
																						echo "<option value='".$row['SID']."' selected>".$name_Value."</option>";         																																				                                    
																					}else{
																						echo "<option value='".$row['SID']."'>".$name_Value."</option>";    
																					}
										 		...
										 		echo "<option value='-1'>--</option>";
           										 while( $row=mysqli_fetch_array($result) ){
														...
														$name_Value = $ob2->su_function_convert_name($conn,"master_user_info_table","SID",$row['SID'],"master_user_info_name");
																					...
																					if($row2['6_layer_aida_sid']==$row['SID']){
																						echo "<option value='".$row['SID']."' selected>".$name_Value."</option>";         																																				                                    
																					}else{
																						echo "<option value='".$row['SID']."'>".$name_Value."</option>";    
																					}
										 		...
										 		echo "<option value='-1'>--</option>";
           										 while( $row=mysqli_fetch_array($result) ){
														...
														$name_Value = $ob2->su_function_convert_name($conn,"master_user_info_table","SID",$row['SID'],"master_user_info_name");
																					...
																					if($row2['7_layer_aida_sid']==$row['SID']){
																						echo "<option value='".$row['SID']."' selected>".$name_Value."</option>";         																																				                                    
																					}else{
																						echo "<option value='".$row['SID']."'>".$name_Value."</option>";    
																					}
