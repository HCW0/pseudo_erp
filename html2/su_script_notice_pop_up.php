...
<script language="javascript">
				window.resizeTo(screen.availWidth/2.9,screen.availHeight*0.65); // 지정한 크기로 변한다.(가로,세로)
			...
			<table summary="글쓰기 전체 테이블">
				...
				<caption>공지사항</caption>	
					...
					<tr>
						...
						<td>
						<textarea name="ir1"  readonly="readonly" class="nse"><?php echo $row['notice_content']?></textarea>
						</td>
