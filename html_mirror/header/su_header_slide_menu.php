		...
		<div style="height:1000px">
			...
			<nav id="cd-lateral-nav">
				<ul class="cd-navigation">
					...
					<br />
					<br />
					<p align="center"><img src=<?php echo $_SESSION['root']."src/su_rsc_sulogo_back.png"; ?> width="200" height="100" title="선운로고" /></p>
					<br />
					<br />
				...
				<font color='white'><?php
					...
					<?php echo "<a href='".$_SESSION['root']."module/login/su_script_logout_support.php'>로그아웃</a>" ?>
			...
			<a href=#none onclick=this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none';><div># 관리자 기능</div></a><DIV style='display:none'><a href="su_script_approbation_management_interface.php" align="right">
				...
				<!-- Resource jQuery -->
				<script language="JavaScript" src="../../src/assets/js/date_picker.js"></script>
